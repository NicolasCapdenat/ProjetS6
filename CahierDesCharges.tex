	...
	\section{fondament du projet}
		\subsection{But Du Projet} 
			...
			\subsubsection{objectif du projet}
				Le but du projet est de realiser un outil automatique d'aide au decryptage, capable de retrouver une grande partie du texte d'origin à partir d'un texte chiffré.Il devra etre capable de decrypte un texte crypté avec un chiffrement par substitution ou par un chiffrement de vignère.
